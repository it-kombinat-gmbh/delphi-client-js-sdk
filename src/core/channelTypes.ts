...
export type BrowserReadyState = 'loading' | 'interactive' | 'ready' | 'error'

export interface BrowserNavigationLink {
    url: string
    title?: string
    description?: string
    id?: string
...
export interface BrowserNavigationCatalog {
    /** Stable site map or current page affordances */
    links?: BrowserNavigationLink[]
    searchQuery?: string
    searchResults?: Array<BrowserNavigationLink & { snippet?: string; score?: number }>
}
...
export interface BrowserContext {
    ...
    readyState?: BrowserReadyState
    readyStateDetail?: string
    /** Where the AI may navigate next */
    navigation?: BrowserNavigationCatalog
    metadata?: Record<string, unknown>
}
